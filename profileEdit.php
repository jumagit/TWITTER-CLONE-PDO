...
if(!empty($_POST['screenName'])){
    ...
    if(strlen($screenName) > 20){
        $error = "Screen Name must be between 5-20 Characters";
...
<head>
    ...
    <meta charset="UTF-8" />
		...
		<script rel="text/javascript" src="<?php echo BASE_URL; ?>ASSETS/JS/jquery-3.2.1.min.js"></script>
			...
			<ul>
				...
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							<li><a href="<?php echo $user->username; ?>K"><?php echo $user->username; ?>E</a></li>
